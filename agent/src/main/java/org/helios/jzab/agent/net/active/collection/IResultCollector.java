...
/**
 * <p>Title: IResultCollector</p>
 * <p>Description: Interface to hide the rest of the collection stream.</p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>org.helios.jzab.agent.net.active.collection.IResultCollector</code></p>
 */
public interface IResultCollector {
	/**
	 * Adds an active check result to the collection stream 
